    ...
    <div class="py-1">
        ...
        <form action="{{ route('subkriteria.update', $subkriteria->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="kode_subkriteria" class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-300"
            ...
            <div>
                ...
                <input type="text" name="nama_subkriteria" class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-300"
            ...
            <div>
                ...
                <input type="number" step="0.1" min="0" max="10" name="nilai_min" id="nilai_min"
                       class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-300"
                       value="{{ $subkriteria->nilai_min }}" required>
            </div>
            ...
            <div>
                ...
                <input type="number" step="0.1" min="0" max="10" name="nilai_max" id="nilai_max"
                       class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-300"
                       value="{{ $subkriteria->nilai_max }}" required>
            </div>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <a href="{{ route('subkriteria.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">
                    Batal
                </a>
            </div>
        </form>
